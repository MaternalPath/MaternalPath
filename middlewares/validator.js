  ...
  const schema = joi.object({
    firstName: joi
      ...
      .messages({
        ...
        "string.pattern.base":
          "First name cannot contain digits and must be a minimum of 3 characters",
      }),
    lastName: joi
      .string()
      .trim()
      ...
      .messages({
        ...
        "string.pattern.base":
          "School name cannot contain digits and must be a minimum of 3 characters",
      }),
    ...
    phoneNumber: joi
      ...
      .messages({
        ...
        "string.pattern.base":
          "Phone number must contain only 10 digit numbers",
      }),
    hospitalId: joi
      .string()
      .trim()
  ...
  const schema = joi.object({
    ...
    newPassword: joi
      ...
      .messages({
        ...
        "string.empty": "Password cannot be Empty",
        "string.pattern.base":
          "Password must be 8 characters and include upper and lower case",
      }),
    confirmPassword: joi
      .string()
      .trim()
  ...
  const schema = joi.object({
    currentPassword: joi
      ...
      .messages({
        ...
        "string.pattern.base":
          "Current password must be at least 8 characters and include 1 uppercase and 1 lowercase",
      }),
    newPassword: joi
      .string()
      .trim()
      ...
      .messages({
        ...
        "string.pattern.base":
          "New password must be at least 8 characters and include 1 uppercase and 1 lowercase",
      }),
  });
  const { error } = schema.validate(req.body);
  ...
  const schema = joi.object({
    ...
    existingHealthConditions: joi
      ...
      .messages({
        ...
        "string.min":
          "Existing health conditions must be at least 2 characters long.",
        "string.max":
    ...
    emergencyContactNumber: joi.string().trim().length(11).pattern(/^[0-9]+$/).required().messages({
        ...
        "string.length":
          "Emergency contact phone number must be exactly 11 digits.",
        "string.pattern.base":
    ...
    linkedPaymentMethod: joi
      .string()
      .valid("card", "bank", "wallet", "ussd", "transfer")
      .required()
      .messages({
        "string.base": "Linked payment method must be a string.",
        "any.only":
          "Payment method must be card, bank, wallet, transfer, or ussd.",
